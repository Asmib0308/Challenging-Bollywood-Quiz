...
async function addPlayer(){
    //Adding a player
      await db.collection("Players").add({email:userId,q_id:qid,score:points})
      playerExists = true
 }
...
function end(){
  swal(
      {
        title: `Game Over!!!`,
        text: "You have successfully completed 15 questions.Thanks for playing!! You are a true Bollywood Lover",
        //imageUrl:"",
        //imageSize: "50x50",
